...
RSpec.describe Retirement do
  ...
  it 'can tell me when I should retire' do
    ...
    expected = "You have 40 years left until you can retire. It is 2025, so you can retire in 2065."
  ...
  it 'tells me when to retire with different ages' do
    ...
    expected = "You have 31 years left until you can retire. It is 2025, so you can retire in 2056."
